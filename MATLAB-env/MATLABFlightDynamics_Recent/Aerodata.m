...
function [Geom, ALPHA_BREAK, F18_Aerodata] = Aerodata
...
clift = [-1.03860  -0.880907  -0.551318  -0.216206   0.154461   0.560857   0.951575 ...
	      1.24168   1.39786    1.53103    1.64110    1.77724    1.88652    1.88940  ...
	      1.80975   1.68556    1.57524    1.46011    1.31884    1.17117    1.02151  ...
	      0.858875  0.685334   0.529482   0.378268   0.229349   9.10933E-02]';

% here is clift_q (lift coeff due to pitch rate)
clift_q = [7.87143E-02    7.87143E-02    7.87144E-02    7.88452E-02    7.64891E-02   6.91587E-02  ...
	       6.33554E-02    5.99084E-02    5.89049E-02    6.05629E-02    6.28755E-02   6.91587E-02  ...
	       8.89245E-02    0.119991       0.147829       0.159698       0.131772      1.03847E-01  ...
	       9.21534E-02    8.79646E-02    8.63938E-02    8.63938E-02    8.49975E-02    8.25541E-02 ...
	       7.97615E-02    7.66200E-02    7.24312E-02]'; 

% here is cd0 (zero-lift drag coeff)
cd0 =  [ 0.227325   0.170673   7.47685E-02    3.20977E-02    2.79305E-02   6.13288E-02 ...
	     0.154023   0.261263   0.363863       0.486635       0.643989      0.863792    ...
	     1.08558    1.27900    1.47638        1.61911        1.74604       1.84448     ...
	     1.92402    1.98384    2.02834        2.06708        2.11362       2.15514     ...
	     2.17363    2.16283    2.12822]';
...
cm = [ 9.62520E-02    8.07290E-02    5.54066E-02    2.80686E-02    5.08503E-03   -6.61034E-03 ...
	  -1.64371E-02   -1.60245E-02   -5.86329E-02   -8.42348E-02   -8.52663E-02   -0.105573    ...
	  -0.117061      -0.110115      -0.114069      -0.118398      -1.01818E-01   -0.146057    ...
	  -0.228343      -0.351592      -0.426319      -0.476887      -0.601749      -0.563499    ...
...
cm_q = [-8.68301E-02   -8.68301E-02   -8.68301E-02   -8.65683E-02   -8.53902E-02 ...
	    ...
	    -8.81828E-02   -1.02364E-01   -0.147655      -0.205556      -0.132732    ...
	     1.80642E-02    4.31969E-02    1.80642E-02   -1.96350E-02   -6.50135E-02 ...
	    -1.00967E-01   -9.81748E-02   -9.53822E-02   -9.25897E-02   -8.90991E-02 ...
	    -8.52593E-02   -8.24668E-02]';
...
CLAD = (1.32/pi)*atan(-(ALPHA_BREAK-5)*5*pi/18)+(-0.75)*atan((ALPHA_BREAK-45)/2)+1.8;
CMAD = -0.02/pi *atan(-(ALPHA_BREAK-1)*5*pi/18) +  0.5*atan((ALPHA_BREAK-6)*5) +  (-0.8)*atan((ALPHA_BREAK-18)/2) +  0.9*atan((ALPHA_BREAK-45)/2)-0.9;


F18_Aerodata = [clift, clift_q, clift_de, clift_del, clift_der, cd0, cd_q, cd_de, cd_del, cd_der, ...
          cm, cm_de, cm_del, cm_der, cm_q, cy_b, cy_p, cy_r, cy_de, cy_del, cy_der, cy_da, cy_dr, ...
          croll_b, croll_p, croll_r, croll_de, croll_del, croll_der, croll_da, croll_dr,          ...
          cn_b, cn_p, cn_r, cn_de, cn_del, cn_der, cn_da, cn_dr, CLAD, CMAD];
% End of aero data
%
%=====================================================================================================
%=====================================================================================================
...
m    = 36099/2.2046;         % 36100 lbs -> Kg   Empty - 29,620 lb, Fuel - 6,480 lb 
g    = 9.81;                 % m/s2
W    = m*g;                  % N
...
Iyy  = 176809*14.59/10.764;  % slugs ft2 -> Kg m2
Izz  = 191744*14.59/10.764;  % slugs ft2 -> Kg m2
Ixz  = -2305*14.59/10.764;   % slugs ft2 -> Kg m2
Ixy  = 0;
Iyz  = 0;
cgcb = 0.238;
xcg  = cgcb*cbar;            % CG location referenced from the leading edge of mean aerodynamic chord 
xref = (cgcb - 0.255)*cbar;  % CG to the reference point distance  (0.017*cbar)
yref = 0;
zref = -0.449*0.3048;        % CG to the reference point distance (zcg = 0)
xeng = -16.4*0.3048;         % Horiz. Dist. CG to engine nozzle = -16.4 ft = -5 m
yeng = 1.775/2.2046;
zeng = -0.55*0.3048;         % Vert.  Dist. CG to engine nozzle = -0.55 ft = -0.1676 m

Geom = [m; S; b; cbar; Ixx; Iyy; Izz; Ixz; Ixy; Iyz; xcg; xref; yref; zref; xeng; yeng; zeng];
...
%  max_thrust = 32000*g/2.2046; % F-18 max. Static thrust (sea-level) static: 16000 lbs x 2 (142.393 KN)

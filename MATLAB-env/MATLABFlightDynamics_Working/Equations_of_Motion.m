...
CD0    = interp1(ALPHA_BREAK,cd0,Alfad, 'cubic');
CD_q   = interp1(ALPHA_BREAK,cd_q,Alfad, 'cubic')*r2d;
CD_de  = interp1(ALPHA_BREAK,cd_de,Alfad, 'cubic')*r2d;
CD_der = interp1(ALPHA_BREAK,cd_der,Alfad, 'cubic')*r2d;
CD_del = interp1(ALPHA_BREAK,cd_del,Alfad, 'cubic')*r2d;

CL0    = interp1(ALPHA_BREAK,clift,Alfad, 'cubic');
CL_q   = interp1(ALPHA_BREAK,clift_q,Alfad, 'cubic')*r2d;
CL_de  = interp1(ALPHA_BREAK,clift_de,Alfad, 'cubic')*r2d;
CL_der = interp1(ALPHA_BREAK,clift_der,Alfad, 'cubic')*r2d;
CL_del = interp1(ALPHA_BREAK,clift_del,Alfad, 'cubic')*r2d;

CY_b   = interp1(ALPHA_BREAK,cy_b,Alfad, 'cubic')*r2d; 
CY_p   = interp1(ALPHA_BREAK,cy_p,Alfad, 'cubic')*r2d; 
CY_r   = interp1(ALPHA_BREAK,cy_r,Alfad, 'cubic')*r2d; 
CY_de  = interp1(ALPHA_BREAK,cy_de,Alfad, 'cubic')*r2d; 
CY_der = interp1(ALPHA_BREAK,cy_der,Alfad, 'cubic')*r2d;
CY_del = interp1(ALPHA_BREAK,cy_del,Alfad, 'cubic')*r2d;
CY_da  = interp1(ALPHA_BREAK,cy_da,Alfad, 'cubic')*r2d; 
CY_dr  = interp1(ALPHA_BREAK,cy_dr,Alfad, 'cubic')*r2d;

Cl_b   = interp1(ALPHA_BREAK,croll_b,Alfad, 'cubic')*r2d; 
Cl_p   = interp1(ALPHA_BREAK,croll_p,Alfad, 'cubic')*r2d; 
Cl_r   = interp1(ALPHA_BREAK,croll_r,Alfad, 'cubic')*r2d; 
Cl_de  = interp1(ALPHA_BREAK,croll_de,Alfad, 'cubic')*r2d; 
Cl_der = interp1(ALPHA_BREAK,croll_der,Alfad, 'cubic')*r2d; 
Cl_del = interp1(ALPHA_BREAK,croll_del,Alfad, 'cubic')*r2d; 
Cl_da  = interp1(ALPHA_BREAK,croll_da,Alfad, 'cubic')*r2d; 
Cl_dr  = interp1(ALPHA_BREAK,croll_dr,Alfad, 'cubic')*r2d;

Cn_b   = interp1(ALPHA_BREAK,cn_b,Alfad, 'cubic')*r2d;
Cn_p   = interp1(ALPHA_BREAK,cn_p,Alfad, 'cubic')*r2d;
Cn_r   = interp1(ALPHA_BREAK,cn_r,Alfad, 'cubic')*r2d;
Cn_de  = interp1(ALPHA_BREAK,cn_de,Alfad, 'cubic')*r2d;
Cn_der = interp1(ALPHA_BREAK,cn_der,Alfad, 'cubic')*r2d;
Cn_del = interp1(ALPHA_BREAK,cn_del,Alfad, 'cubic')*r2d;
Cn_da  = interp1(ALPHA_BREAK,cn_da,Alfad, 'cubic')*r2d;
Cn_dr  = interp1(ALPHA_BREAK,cn_dr,Alfad, 'cubic')*r2d;

Cm0    = interp1(ALPHA_BREAK,cm,Alfad, 'cubic');
Cm_q   = interp1(ALPHA_BREAK,cm_q,Alfad, 'cubic')*r2d;
Cm_de  = interp1(ALPHA_BREAK,cm_de,Alfad, 'cubic')*r2d;
Cm_der = interp1(ALPHA_BREAK,cm_der,Alfad, 'cubic')*r2d;
Cm_del = interp1(ALPHA_BREAK,cm_del,Alfad, 'cubic')*r2d;

CL_Ad = interp1(ALPHA_BREAK,CLAD,Alfad, 'cubic')*r2d;
Cm_Ad = interp1(ALPHA_BREAK,CMAD,Alfad, 'cubic')*r2d;


d_CL    =  interp1(ALPHA_BREAK,d_CLv,Alfad, 'cubic');
d_CD    =  interp1(ALPHA_BREAK,d_CDv,Alfad, 'cubic');
d_Cm    =  interp1(ALPHA_BREAK,d_Cmv,Alfad, 'cubic');
d_CY    = -interp1(ALPHA_BREAK,d_CYv,Alfad, 'cubic');
d_Cl    = -interp1(ALPHA_BREAK,d_Clv,Alfad, 'cubic');
d_Cn    =  interp1(ALPHA_BREAK,d_Cnv,Alfad, 'cubic');
d_Cl_da = -interp1(ALPHA_BREAK,d_Cl_dav,Alfad, 'cubic')*r2d;
d_Cn_da = -interp1(ALPHA_BREAK,d_Cn_dav,Alfad, 'cubic')*r2d;
d_CL_da = -interp1(ALPHA_BREAK,d_CL_dav,Alfad, 'cubic')*r2d;
d_CD_da = -interp1(ALPHA_BREAK,d_CD_dav,Alfad, 'cubic')*r2d;
d_Cm_da = -interp1(ALPHA_BREAK,d_Cm_dav,Alfad, 'cubic')*r2d;
d_Cl_q  = -interp1(ALPHA_BREAK,d_Cl_qv,Alfad, 'cubic')*r2d;
d_Cm_q  =  interp1(ALPHA_BREAK,d_Cm_qv,Alfad, 'cubic')*r2d;
d_CL_q  =  interp1(ALPHA_BREAK,d_CL_qv,Alfad, 'cubic')*r2d;
d_CL_p  =  interp1(ALPHA_BREAK,d_CL_pv,Alfad, 'cubic')*r2d;
d_CD_p  =  interp1(ALPHA_BREAK,d_CD_pv,Alfad, 'cubic')*r2d;
d_Cm_p  =  interp1(ALPHA_BREAK,d_Cm_pv,Alfad, 'cubic')*r2d;
d_Cl_p  =  interp1(ALPHA_BREAK,d_Cl_pv,Alfad, 'cubic')*r2d;
d_Cl_r  =  interp1(ALPHA_BREAK,d_Cl_rv,Alfad, 'cubic')*r2d;
